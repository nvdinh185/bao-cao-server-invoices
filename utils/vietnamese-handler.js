...
const convertMonthVN = (yyyymm)=>{
    return yyyymm?yyyymm.slice(4,6)+"/"+yyyymm.slice(0,4):"";
}

const convertDateVN = (yyyymmdd) =>{
    return yyyymmdd?yyyymmdd.slice(6,8)+"/"+yyyymmdd.slice(4,6)+"/"+yyyymmdd.slice(0,4):"";
}
...
module.exports = {
    ...
    //chuyển đổi yyyymmdd sang dd/mm/yyyy...
    convertMonthVN: convertMonthVN,
    convertDateVN: convertDateVN
};
